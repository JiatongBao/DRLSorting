...
rtc_port = 30003
workspace_limits = np.asarray([[-0.10418, 0.17582], [-0.48669, -0.20669], [0.006, 0.313]])  # np.asarray([[-0.16, 0.21], [-0.35, -0.25], [0.30, 0.36]]) # Cols: min max, Rows: x y z (define workspace limits in robot coordinates)
...
def mouseclick_callback(event, x, y, flags, param):
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        target_position[2] = target_position[2] + 0.24
